       ...
       <div className="flex flex-col md:flex-row gap-6 mb-8">
          <div className="card bg-gradient-to-br from-primary to-primary-light flex-1 p-8 text-white flex items-center justify-between overflow-hidden relative">
             <div className="relative z-10 w-2/3">
                ...
                <button className="btn bg-white text-primary hover:bg-gray-100 font-bold px-6 py-2 shadow-lg">Start AI Drill</button>
             </div>
          ...
          <div className="card w-full md:w-1/3 p-6 flex flex-col justify-center items-center text-center">
             ...
             <button className="text-sm font-bold text-secondary flex items-center gap-1 hover:underline">Explore Library <ArrowRight size={14}/></button>
          </div>
       </div>
